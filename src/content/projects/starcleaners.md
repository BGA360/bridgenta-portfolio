...
### Artefakt 1: Benutzeroberfläche & Layout-Konzept

<figure>
  <img src="/images/starcleaners-portfolio/starcleaners-artifact-01-interface-layout.webp" alt="Dokumentationsrekonstruktion der StarCleaners-Seitenstruktur mit PWA-Features, Leistungsübersicht und Offline-Status-Indikator." loading="lazy" width="1672" height="941" />
  <figcaption><strong>Artefakt 1: Benutzeroberfläche des Service-Portals</strong> – Typ: Dokumentationsrekonstruktion. Quelle: Ursprüngliches StarCleaners-Designkonzept. Zweck: Veranschaulichung der Benutzeroberfläche und der PWA-Offline-Indikatoren. Nachweisstatus: Konzeptionelle Benutzeroberfläche; kein Nachweis über aktive Live-Buchungen.</figcaption>
</figure>

### Artefakt 2: Caching- und Offline-Workflow

<figure>
  <img src="/images/starcleaners-portfolio/starcleaners-artifact-02-caching-workflow.webp" alt="Architekturdiagramm der Service-Worker Caching-Schicht mit dem clientseitigen Cache-First-Ablauf." loading="lazy" width="1672" height="941" />
  <figcaption><strong>Artefakt 2: Service-Worker-Ablaufdiagramm</strong> – Typ: Architekturdiagramm. Quelle: Rekonstruktion der deklarierten Anwendungsarchitektur. Zweck: Veranschaulichung des Datenflusses der Service-Worker-Caching-Schicht. Nachweisstatus: Implementierungsmodell; kein Laufzeit- oder Sicherheits-Audit der Caching-Schicht.</figcaption>
</figure>

### Artefakt 3: Lokales SEO-Entitätsschema

<figure>
  <img src="/images/starcleaners-portfolio/starcleaners-artifact-03-seo-schema.webp" alt="Strukturdiagramm der verknüpften JSON-LD Schema.org Entitäten für StarCleaners mit LocalBusiness, PostalAddress, Person und Service." loading="lazy" width="1672" height="941" />
  <figcaption><strong>Artefakt 3: Semantische JSON-LD Entitäten-Struktur</strong> – Typ: Architekturdiagramm. Quelle: Strukturierte Metadaten-Modellierung. Zweck: Veranschaulichung der semantischen Beziehungen im lokalen SEO-Schema. Nachweisstatus: Belegt das strukturelle Schema-Konzept; kein Nachweis von Suchmaschinen-Rankings oder Konversionen.</figcaption>
</figure>
