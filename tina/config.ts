...
// Your hosting and database configuration
const branch =
    ...
    collections: [
      {
        ...
        fields: [
          ...
          },
          {
            type: "string",
            name: "description",
            label: "Kurzbeschreibung (für Katalog)",
            required: true,
            ui: {
              component: "textarea",
            },
            ...
            fields: [
              {
                ...
                fields: [
                  ...
                  { type: "string", name: "primaryCtaText", label: "Primärer Button Text" },
                  { type: "string", name: "primaryCtaLink", label: "Primärer Button Link" },
                  { type: "string", name: "secondaryCtaText", label: "Sekundärer Button Text" },
                  { type: "string", name: "secondaryCtaLink", label: "Sekundärer Button Link" },
              ...
              },
              {
                type: "object",
                name: "about",
                label: "Über Mich Vorschau",
                fields: [
                  { type: "string", name: "badge", label: "Badge-Text" },
                  { type: "string", name: "title", label: "Hauptüberschrift" },
              ...
              },
              {
                type: "object",
                name: "skillsHeader",
                label: "Bereichs-Header: Fähigkeiten",
                fields: [
                  { type: "string", name: "eyebrow", label: "Augenbraue (Eyebrow)" },
                  { type: "string", name: "title", label: "Titel" },
                  { type: "string", name: "description", label: "Beschreibungstext", ui: { component: "textarea" } }
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                fields: [
                  { type: "string", name: "cvSubject", label: "Betreffzeile für Lebenslauf-Knopf" },
                  ...
                  { type: "string", name: "openFor", label: "Offen für (Beschreibungstext)", ui: { component: "textarea" } }
                ]
              }
            ]
          },
            ...
            fields: [
              {
                ...
                fields: [
                  { type: "string", name: "availability", label: "Verfügbarkeit" },
