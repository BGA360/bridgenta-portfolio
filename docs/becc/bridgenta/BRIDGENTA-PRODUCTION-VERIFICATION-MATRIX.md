...
| **BG-PROD-013** | Cache / Version check | Live page serves the latest version, not cached stale state. | Verified by checking updated `Datensicherheit` term. | Node.js https search | None | None | None | None | Verified |
