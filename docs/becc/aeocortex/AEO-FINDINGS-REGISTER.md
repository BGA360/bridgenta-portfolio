...
| :--- | :--- | :--- | :--- | :---: | :--- | :---: |
| **AEO-FIND-001** | Heading Structure | 12 H2 headings are written in English (e.g. `Executive Summary`, `Context`). | Wording not aligned to German-only heading standard. | **High** | `BECC-PUBLIC-PAGE-REFERENCE-STANDARD-v1.0.md` Section 1 | **Open** |
